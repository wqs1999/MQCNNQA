...
if __name__ == '__main__':
    ...
    Net = torch.nn.Sequential(
        ...
        # torch.nn.ReLU(),
        # torch.nn.Linear(in_features=60, out_features=10),
    )
    ...
    with open("./acc_and_loss/acc_10.txt", "w") as f:
        for accuracy in accuracies:
            f.write(str(accuracy) + '\n')
    with open("./acc_and_loss/loss_10.txt", "w") as f:
        for loss_copy in test_loss:
